...
// Usuarios
app.post("/api/usuarios/altaUsuario", [verificaToken, ADMINISTRADOR], CTR_USUARIOS.AltaUsuarioBO);
...
// app.get("/api/empresa/:Id", [verificaToken, ADMINISTRADOR], CTR_EMPRESAS.ObtenerEmpresaPorId);
